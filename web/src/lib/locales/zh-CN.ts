export default {
  ...
  'sessions.machineFilter.unknownOwner': '未知归属',
  'sessions.machineFilter.renameTitle': '设置别名 · {name}',
  'sessions.machineFilter.renameHint': '别名对所有账号可见；留空恢复为主机名。',
  'sessions.machineFilter.renameTooltip': '右键设置别名',
  ...
  'newSession.model.proxyCatalog': '代理模型',
  'newSession.model.proxyCatalogUpdated': '更新于 {time}',
  'newSession.model.proxyCatalogStale': '旧快照',
  'newSession.model.proxyCatalogLoading': '正在加载代理模型…',
  'newSession.model.proxyCatalogRefresh': '刷新',
  'newSession.model.proxyCatalogError': '代理模型目录不可用',
  'newSession.model.proxyCatalogUnlisted': '上次记住的模型 {model} 代理已不再提供，已重置为默认。',
  'newSession.ccSwitchProvider': '供应商（cc-switch）',
  'newSession.ccSwitchProvider.followCurrent': '跟随机器当前：{name}',
  'newSession.ccSwitchProvider.followCurrentUnknown': '跟随机器当前供应商',
  'newSession.ccSwitchProvider.currentMark': '当前',
  'newSession.ccSwitchProvider.hint': '只对本会话生效：runner 把该供应商的 env 注入这一个 Claude 进程，不改机器上的 cc-switch。要跑上面的代理模型请选 cx2cc 供应商。',
