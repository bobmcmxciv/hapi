export default {
  ...
  'sessions.machineFilter.unknownOwner': 'Unknown owner',
  'sessions.machineFilter.renameTitle': 'Set alias · {name}',
  'sessions.machineFilter.renameHint': 'The alias is visible to every account; leave empty to fall back to the hostname.',
  'sessions.machineFilter.renameTooltip': 'Right-click to set an alias',
  ...
  'newSession.model.proxyCatalog': 'Proxy models',
  'newSession.model.proxyCatalogUpdated': 'updated {time}',
  'newSession.model.proxyCatalogStale': 'stale',
  'newSession.model.proxyCatalogLoading': 'Loading proxy models…',
  'newSession.model.proxyCatalogRefresh': 'Refresh',
  'newSession.model.proxyCatalogError': 'Proxy models unavailable',
  'newSession.model.proxyCatalogUnlisted': 'The remembered model {model} is no longer offered by the proxy; reset to Default.',
  'newSession.ccSwitchProvider': 'Provider (cc-switch)',
  'newSession.ccSwitchProvider.followCurrent': 'Follow machine current: {name}',
  'newSession.ccSwitchProvider.followCurrentUnknown': 'Follow machine current provider',
  'newSession.ccSwitchProvider.currentMark': 'current',
  'newSession.ccSwitchProvider.hint': 'Applies to this session only: the runner injects that provider\'s env into the Claude process. cc-switch on the machine is not changed. Pick a cx2cc provider to run the proxy models above.',
